...
class Message(ndb.Model):
    contenidonombre = ndb.StringProperty()

    contenidocorreo = ndb.StringProperty()

    contenidotexto = ndb.StringProperty()

    # este campo se añadió más tarde, al principio no estaba y quedó vacío
    contenidofecha = ndb.DateTimeProperty(auto_now_add=True)
